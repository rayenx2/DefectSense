...
with st.sidebar:
    ...
    resize_width = st.number_input("Resize Width", min_value=32, max_value=1024, value=224, step=8)
    resize_height = st.number_input("Resize Height", min_value=32, max_value=1024, value=224, step=8)
