...
def setup_logging(
    ...
    anomavision_logger = logging.getLogger("defectsense")
...
def disable_logging(logger_name: Optional[str] = None) -> None:
    ...
    Example:
        ...
        >>> from defectsense.utils import disable_logging
        >>> disable_logging()
    ...
    if logger_name is None:
        logger_name = "defectsense"  # Your package name
...
def enable_logging(logger_name: Optional[str] = None, level: str = "INFO") -> None:
    ...
    Example:
        >>> from defectsense.utils import enable_logging
...
def find_best_threshold_accuracy(labels, scores):
...
def find_optimal_threshold(labels, scores):
    ...
    # remove last point (no threshold there)
